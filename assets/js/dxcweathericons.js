...
window['windIconSlow'] = function(index, f, thisIcon)
{
	var tl = new TimelineLite({onStart:animationComplete, onStartParams:[index, true], onReverseComplete:animationComplete, onReverseCompleteParams:[index, false]})
...
window['windIconMedium'] = function(index, f, thisIcon)
{
	var tl = new TimelineLite({onStart:animationComplete, onStartParams:[index, true], onReverseComplete:animationComplete, onReverseCompleteParams:[index, false]})
		.from(f.select("#dashedLines").node, .3, {alpha:0}, "-=.1")
		.timeScale(1.5);
...
window['windIconFast'] = function(index, f, thisIcon)
{
	var tl = new TimelineLite({onStart:animationComplete, onStartParams:[index, true], onReverseComplete:animationComplete, onReverseCompleteParams:[index, false]})
		.from(f.select("#dashedLines").node, .3, {alpha:0}, "-=.1")
		.timeScale(2);
...
window['windIconGust'] = function(index, f, thisIcon)
{
	var tl = new TimelineLite({onStart:animationComplete, onStartParams:[index, true], onReverseComplete:animationComplete, onReverseCompleteParams:[index, false]})
		.from(f.select("#dashedLines").node, .3, {alpha:0}, "-=.1")
		.timeScale(2.5);
...
window['windIconStorm'] = function(index, f, thisIcon)
{
	var tl = new TimelineLite({onStart:animationComplete, onStartParams:[index, true], onReverseComplete:animationComplete, onReverseCompleteParams:[index, false]})
		.from(f.select("#dashedLines").node, .3, {alpha:0}, "-=.1")
		.timeScale(3);
